...
{
    return zend_ini_long(const_cast<char*>(_name.c_str()), (uint32_t)_name.size(), _isorig);
...
{
    return zend_ini_string(const_cast<char*>(_name.c_str()), (uint32_t)_name.size(), _isorig);
}
...
{
    return zend_ini_double(const_cast<char*>(_name.c_str()), (uint32_t)_name.size(), _isorig);
}
